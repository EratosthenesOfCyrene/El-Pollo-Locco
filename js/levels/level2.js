/**
 * Initializes level 2 with all required game objects including enemies, clouds,
    ...
    constructor() {
        super(
            ...
            [
                ...
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 8, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/3_third_layer/1.png', 719 * 8, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/2_second_layer/1.png', 719 * 8, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/1_first_layer/1.png', 719 * 8, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 9, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/3_third_layer/2.png', 719 * 9, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/2_second_layer/2.png', 719 * 9, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/1_first_layer/2.png', 719 * 9, 0),

                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 10, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/3_third_layer/1.png', 719 * 10, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/2_second_layer/1.png', 719 * 10, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/1_first_layer/1.png', 719 * 10, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 11, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/3_third_layer/2.png', 719 * 11, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/2_second_layer/2.png', 719 * 11, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/1_first_layer/2.png', 719 * 11, 0),

                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 12, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/3_third_layer/1.png', 719 * 12, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/2_second_layer/1.png', 719 * 12, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/1_first_layer/1.png', 719 * 12, 0),
                new BackgroundObject('./img_pollo_locco/img/5_background/layers/air.png', 719 * 13, 0),
